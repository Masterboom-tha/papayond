...
export async function POST(request) {
  ...
  try {
    ...
    // ดึงข้อมูลจากตาราง address_booking และ address_print โดยใช้ uni_id และ booking_no
    const [rows] = await connection.execute(
      `
      SELECT ab.id, ab.booking_no, ab.signs_id, ab.fname, ab.lname, ab.uni_id, ab.addno, ab.moo, ab.soi, ab.road, ab.tumbol, ab.amphur, ab.province, ab.zip, ab.tel, ab.film_no, ab.name_for_rec,
